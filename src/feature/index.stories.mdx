...
export const DEFAULTS = {
  ...
  bylines: [{ name: 'Ændra Rininsland', url: 'https://ft.com/ændra-rininsland' }],
  image: {
...
export const ExampleBackground = ({ page }) => (
  <div
    style={{
      backgroundImage:
        'url(https://www.ft.com/__origami/service/image/v2/images/raw/https%3A%2F%2Fd1e00ek4ebabms.cloudfront.net%2Fproduction%2Fc2b95004-9257-4657-be7d-3ed5e20fe72a.jpg?source=g-components)',
...
`<Feature />` is a type of layout that enables a carousel-esque experience on desktop and a paged layout on mobile.
