...
const Footer = () => {
  ...
  return (
    <footer
      ref={ref}
      data-o-footer--no-js=""
      className={classNames(styles['o-footer'], styles['o-footer--theme-dark'])}
      data-o-component="o-footer"
    >
      <div className={styles['o-footer__container']}>
        <div className={styles['o-footer__row']}>
          <nav className={styles['o-footer__matrix']} role="navigation" aria-label="Useful links">
            <div
              className={classNames(
                styles['o-footer__matrix-group'],
                styles['o-footer__matrix-group--1'],
              )}
            >
              <h3 className={styles['o-footer__matrix-title']}>Support</h3>
              <div className={styles['o-footer__matrix-content']} id="o-footer-section-0">
                <div className={styles['o-footer__matrix-column']}>
                  <a
                    className={styles['o-footer__matrix-link']}
                    href="/tour"
                    data-trackable="View Site Tips"
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>View Site Tips</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Help Centre</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Contact Us</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>About Us</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Accessibility</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>myFT Tour</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Careers</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            >
              <h3 className={styles['o-footer__matrix-title']}>Legal &amp; Privacy</h3>
              <div className={styles['o-footer__matrix-content']} id="o-footer-section-1">
                <div className={styles['o-footer__matrix-column']}>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>
                      Terms &amp; Conditions
                    </span>
                  </a>
                  <a
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Privacy Policy</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Cookies</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Copyright</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
            ...
            >
              <h3 className={styles['o-footer__matrix-title']} aria-controls="o-footer-section-2">
                Services
              </h3>
              <div className={styles['o-footer__matrix-content']} id="o-footer-section-2">
                <div className={styles['o-footer__matrix-column']}>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Republishing</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>FT Transact</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Secondary Schools</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            >
              <h3 className={styles['o-footer__matrix-title']} aria-controls="o-footer-section-3">
                Tools
              </h3>
              <div className={styles['o-footer__matrix-content']} id="o-footer-section-3">
                <div className={styles['o-footer__matrix-column']}>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Portfolio</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Alerts Hub</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Enterprise Tools</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>News feed</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>Newsletters</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
            ...
            >
              <h3 className={styles['o-footer__matrix-title']} aria-controls="o-footer-section-4">
                Community &amp; Events
              </h3>
              <div className={styles['o-footer__matrix-content']} id="o-footer-section-4">
                <div className={styles['o-footer__matrix-column']}>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>FT Community</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>FT Live</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
                  ...
                  >
                    <span className={styles['o-footer__matrix-link__copy']}>FT Forums</span>
                  </a>
                  <a
                    className={styles['o-footer__matrix-link']}
            ...
            >
              <h3
                className={classNames(
                  styles['o-footer__matrix-title'],
                  styles['o-footer__matrix-title--link'],
                )}
              >
                <a
                  className={classNames(
                    styles['o-footer__matrix-link'],
                    styles['o-footer__matrix-link--more'],
                  )}
        ...
        <div className={styles['o-footer__copyright']} role="contentinfo">
          <small>
      ...
      <div className={styles['o-footer__brand']}>
        <div className={styles['o-footer__container']}>
          <div className={styles['o-footer__brand-logo']} />
        </div>
      </div>
    </footer>
  );
